...
function VuBattleRoyaleLootSystemServer:OnPlayerAuthenticated(p_Player)
    ...
    local s_ItemPP2000 = BRItemWeapon(nil, m_WeaponDefinitions["weapon-pp2000"], 1)
    local s_ItemAK = BRItemWeapon(nil, m_WeaponDefinitions["weapon-ak74m"], 1)
    ...
    local s_ItemAttachment = BRItemAttachment(nil, m_AttachmentDefinitions["attachment-acog"], nil)
    m_ItemDatabase:RegisterItem(s_ItemAttachment)
    s_Inventory:AddItem(s_ItemAttachment.m_Id)

    local s_ItemAmmo1 = BRItemAmmo(nil, m_AmmoDefinitions["ammo-556mm"], 30)
    local s_ItemAmmo2 = BRItemAmmo(nil, m_AmmoDefinitions["ammo-556mm"], 24)
    local s_ItemAmmo3 = BRItemAmmo(nil, m_AmmoDefinitions["ammo-556mm"], 30)
    ...
    local s_ItemArmor = BRItemArmor(nil, m_ArmorDefinitions["armor-basic"], nil)
    m_ItemDatabase:RegisterItem(s_ItemArmor)
    s_Inventory:AddItem(s_ItemArmor.m_Id)

    local s_ItemHelmet = BRItemHelmet(nil, m_HelmetDefinitions["helmet-basic"], nil)
