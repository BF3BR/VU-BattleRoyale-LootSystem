...
function VuBattleRoyaleLootSystemShared:OnLevelLoaded()
    ...
    m_ItemDatabase:AddItem(s_ItemPP2000:AsTable())
    m_ItemDatabase:AddItem(s_ItemAK:AsTable())
    ...
    m_ItemDatabase:AddItem(s_ItemAmmo1:AsTable())
    m_ItemDatabase:AddItem(s_ItemAmmo2:AsTable())
    m_ItemDatabase:AddItem(s_ItemAmmo3:AsTable())
