...
function VuBattleRoyaleLootSystemShared:OnLevelLoaded()
    ...
    m_ItemDatabase:AddItem(s_ItemPP2000)
    m_ItemDatabase:AddItem(s_ItemAK)
    ...
    m_ItemDatabase:AddItem(s_ItemAmmo1)
    m_ItemDatabase:AddItem(s_ItemAmmo2)
    m_ItemDatabase:AddItem(s_ItemAmmo3)
