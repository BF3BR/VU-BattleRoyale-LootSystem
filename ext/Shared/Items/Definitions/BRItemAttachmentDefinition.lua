...
return {
    ACOG = BRItemAttachmentDefinition(
        ...
        {
            Partition = Guid("D01B86C8-5176-E446-85CB-DE8871DAC528"),
            Instance = Guid("D7875B6B-37F1-4C5D-60CD-273DDA3E553F")
        },
        {
    ...
    Suppressor = BRItemAttachmentDefinition(
        ...
        {
            Partition = Guid("0B08EAEF-553D-CAD3-D7A4-CA770735FFFA"),
            Instance = Guid("F8FC2931-D0E1-3102-5FD0-E474B9CAAB66")
        },
        {
            m_WeaponDefinitions["AK-74M"],
            m_WeaponDefinitions["PP-2000"]
